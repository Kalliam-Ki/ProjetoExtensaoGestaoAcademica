...
public class AlunoProjetoController {
    ...
    public AlunoProjetoController(AlunoProjetoService alunoProjetoService, SecurityUtils securityUtils) {
    ...
    public ResponseEntity<Void> desvincularAlunoProjeto(@PathVariable Long alunoProjetoId) {
        Long usuarioId = securityUtils.getUsuarioLogadoId();
    ...
    public ResponseEntity<Void> reativarVinculo(@PathVariable Long alunoProjetoId) {
        Long usuarioId = securityUtils.getUsuarioLogadoId();
