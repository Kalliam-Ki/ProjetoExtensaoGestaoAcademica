...
public class AuditoriaService {
    ...
    public void registrarAlteracao(String tabelaAfetada, Long idRegistroAfetado, String acao,
        ...
        try {
            ...
            // Não lançamos exceção para não quebrar o fluxo principal
        }
    }
    ...
    private LogAlteracaoResponseDTO converterParaDTO(LogAlteracao log) {
        if (log == null) {
            logger.error("Tentativa de converter LogAlteracao nulo para DTO");
            throw new RuntimeException("LogAlteracao nao pode ser nulo");
        }
